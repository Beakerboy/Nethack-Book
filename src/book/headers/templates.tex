...
\newcommand{\LaTeXAppendixTemplate}[1]{\appendix}



\newcommand{\LaTeXEquals}[1]{=}

\newcommand{\LaTeXJavaEnumTemplate}[1]{\textbf{enum}}
\newcommand{\LaTeXJavaStringTemplate}[1]{\texttt{\textbf{#1}}}
\newcommand{\LaTeXAccentTemplate}[1]{'}


\newcommand{\LaTeXJavaEBNFTemplate}[1]{Extended Backus-Naur Form}
...
\newcommand{\LaTeXProblemTemplate}[1]{
\LaTeXDoubleBoxTemplate{Problem:}{#1}
}
...
\newcommand{\LaTeXexampleTemplate}[1]{\LaTeXDoubleBoxTemplate{Example:}{#1}}
\newcommand{\LaTeXNoteTemplate}[1]{\LaTeXDoubleBoxTemplate{Note:}{#1}}
\newcommand{\LaTeXConsoleTemplate}[1]{\LaTeXDoubleBoxTemplate{Console:}{#1}}
...
\begin{longtable}{|p{0.9\linewidth}|}\hline
#1 \\ \hline 
\end{longtable}}
...
\renewcommand{\Smiley}[1]{$\ddot\smile$}
